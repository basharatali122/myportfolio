...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Basharat Ali — Full-Stack Engineer" },
      { name: "twitter:description", content: "MERN + Python/Flask developer. Real-time apps, REST APIs, automation, RAG chatbots." },
